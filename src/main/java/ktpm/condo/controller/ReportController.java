...
import ktpm.condo.model.service.report_service.IReportService;
import ktpm.condo.model.service.report_service.ReportService;

/**
 * Controller điều phối báo cáo thống kê.
 */
public class ReportController {
    private final IReportService service = new ReportService();
    ...
    public Map<String, Double> getTotalFeeByServiceType() {
        return service.getTotalFeeByServiceType();
    }
}
